...
class NSGA2():
    ...
    def fitness(self, demands_provider_np, demands_pdd_np, popu):
        ...
        # 统一转成最小化问题
        pop_fitness = np.vstack((1 / y1_values_double, 1000 * y2_values_double, 20 / y3_values_double)).T
        return pop_fitness
    ...
    def draw_fitness_graph(self, demands_provider_np, demands_pdd_np, population_front0):  # 画图
        """
        绘制结果图
        :param demands_provider_np:
        :param demands_pdd_np:
    ...
    def show_population_frequency_bar_graph(self,result_popu,provider_id_list):
        """
    ...
    def excute(self, demands_provider_np, demands_pdd_np,provider_id_list):
        """
        # 主程序
        :param demands_provider_np:
        :param demands_pdd_np:
        ...
        # 绘制非劣解的fitness关联图
        self.draw_fitness_graph(demands_provider_np, demands_pdd_np, population_front0)
        # 绘制频率分布图
        frequency_result=self.show_population_frequency_bar_graph(population_front0,provider_id_list)
        # 将frequency_result存储到文件夹中
        np.savez("./frequency_result",best_solution_result=frequency_result[0],frequency=frequency_result[1])
...
def main_55():
    ...
    nsga2_obj.excute(demands_provider_np, demands_pdd_np,provider_id_list)
