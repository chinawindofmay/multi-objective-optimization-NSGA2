...
内置函数：程序入口
"""
def do_it(from_row,n_rows):
    mongo_operater_obj = a_mongo_operater.MongoOperater(DB_NAME, COLLECTION_NAME)
    n_fetched = 0
    #构建每条记录的请求体
    with SaverDataOfRPQ(mongo_operater_obj) as save_data_of_rpq, RPQueue() as route_planner_queue:
...
if __name__ == "__main__":
    ...
    """
    # from_row=0
    # n_rows=251#Driving一天请求量是30万
    # for i in range(n_rows):
    n_rows_fatch = do_it(0, 184)
