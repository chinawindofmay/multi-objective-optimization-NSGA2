...
# field_name=["accessibility08","accessibility13","accessibility18","accessibility22"]#字段名称
# nb_class=5#级数
# round_num=0.001#取整
# decimal_num=3 #小数位数

### 不公平性
mxd_file_path="{0}\\jianye_TMooPs_1227_inequality.mxd".format(file_path) #mxd名称
lyr_name=u"Inequality"#图层名称
field_name=["inequlity08","inequlity13","inequlity18","inequlity22"]#字段名称
nb_class=5#级数
round_num=0.001#取整
decimal_num=3 #小数位数
